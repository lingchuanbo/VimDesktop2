...
SaveAllConfig(*) {
    ...
    UTF8IniWrite(Data["MenuCooldownMsCtrl"].Value, IniFile, "Settings", "MenuCooldownMs")
    ...
    UTF8IniWrite(Data["LogRetentionDaysCtrl"].Value, IniFile, "Settings", "LogRetentionDays")
