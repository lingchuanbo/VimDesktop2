...
ShowWindowSwitchMenu(*) {
    ...
    try {
        ...
        contextMenu := RuntimeWindowMenu.Render(windowSnapshot, &stageTick, startTick)
...
ShowFileDialogMenuInternal() {
    ...
    try {
        ...
        contextMenu := RuntimeFileDialogMenu.Render(fileManagerWindows, &stageTick, startTick)
        RuntimeLog.LogMenuStageElapsed("FileDialog", "render_menu", &stageTick, startTick, g_MenuItems.Length)
...
ToggleTheme(*) {
    ...
    try {
        ...
        ; 更新任务栏菜单显示
        RuntimeApp.UpdateTrayMenuThemeStatus()
